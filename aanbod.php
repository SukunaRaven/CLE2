...
<main class="has-background-info">
    ...
    <section class="container">
        ...
        <p class="has-text-centered">
            ...
            Of je nu een verjaardagsfeest, bedrijfsbijeenkomst, familiediner of een ander soort evenement plant, wij bieden de perfecte setting en service voor jouw gelegenheid.
            Onze groepsmenu's zijn speciaal samengesteld om aan de verschillende smaken en voorkeuren van jouw gezelschap te voldoen.
            ...
            <div class="column">
                <article class="card content">
                    ...
                    <p>
                        Of je nu een zakelijke lunch, een diner, een vergadering of een bedrijfsfeest organiseert, bij BROERS bieden we de ideale omgeving voor professionele bijeenkomsten.
                        Wij begrijpen de behoeften van bedrijven en zorgen ervoor dat elk zakelijk evenement met zorg, professionaliteit en stijl wordt uitgevoerd.
                    </p>
                    <p>
                        Onze zakelijke diensten:
                    </p>
                    <ul>
                        <li>Vergaderingen en Presentaties: Mogelijkheid tot prive ruimte. Ruimte is flexibel in te richten voor zowel kleine teams als grotere groepen.
                        </li>
                        <li>Zakelijke lunches en diners: Organiseer een lunch of diner voor klanten, collega's of zakenpartners.
                            Wij bieden een op maat samengesteld menu met zakelijke lunchopties of een dinerarrangement dat aansluit bij de gelegenheid.
                        </li>
                        <li>Catering voor bedrijven: Wij bieden flexibele cateringdiensten voor externe evenementen, vergaderingen of bedrijfsborrels.
                            Van finger food en borrelhapjes tot een volledig buffet of geserveerde maaltijd, we zorgen voor een smaakvolle ervaring.
                        </li>
                        <li>Netwerkevenementen: Organiseer een netwerkborrel of een klantenevenement in een professionele, ontspannen sfeer.
                            Onze experts helpen je bij het creëren van de juiste ambiance, met drankenarrangementen, hapjes en andere faciliteiten.
                        </li>
                        <li>Bedrijfsevenementen en teambuilding: Organiseer een bedrijfsfeest, jubileum of teambuilding-activiteit.
                            Of het nu gaat om een feestelijk diner, een informele borrel of een uitgebreide bedrijfsbijeenkomst, wij zorgen voor de juiste setting en uitstekende service.
                        </li>
                    </ul>
                </article>
            </div>
            ...
            <div class="column">
                <article class="card content">
                    ...
                    <p>
                        Bij BROERS bieden we een heerlijke High Tea ervaring, perfect voor een ontspannen middag met vrienden, familie of collega’s.
                        Laat je verwennen met een assortiment van verse theesoorten, delicate sandwiches, huisgemaakte scones, zoete lekkernijen en andere smakelijke hapjes.
                    ...
                    <ul>
                        <li>Een uitgebreide selectie thee:
                            Kies uit diverse theesoorten, van klassieke Engelse ontbijt- en Earl Grey-thee tot verfijnde groene en kruideninfusies.
                        </li>
                        <li>Verse sandwiches:
                            Geniet van verfijnde sandwiches met diverse vullingen, zoals gerookte zalm, komkommer en roomkaas, en luxe vleeswaren.
                        </li>
                        <li>Heerlijke scones:
                            Onze huisgemaakte scones worden geserveerd met clotted cream en fruitige jam, voor de ultieme smaakbeleving.
                        </li>
                        <li>Zoete lekkernijen:
                            Diverse zoete hapjes zoals taartjes, macarons, petit fours en brownies.
                        </li>
                        <li>Speciale dieetwensen:
                            We bieden ook high tea-arrangementen voor vegetariërs, veganisten, of gasten met gluten- of lactose-intolerantie.
